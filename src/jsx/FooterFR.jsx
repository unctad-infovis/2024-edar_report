          ...
          <div className="footer_element footer_element_1">
            <div className="footer_content anchor_videos" id="anchor_videos">
              ...
              <div className="iframe_container youtube_iframe">
                <iframe src="https://www.youtube.com/embed/mXCK_71vr_I" title="Rapport 2024 sur le développement économique en Afrique" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
              </div>
              <ul>
                <li>
                  <a href="https://youtu.be/y_eM0gxqNgc" target="_blank" rel="noreferrer">English</a>
                  {', '}
              ...
              <ul>
                {/* <li>
                  <a href="#download" target="_blank" rel="noreferrer">Conférence de presse</a>
                </li> */}
                <li>
                  <a href="https://www.flickr.com/photos/unctad/albums/72177720323742073/" target="_blank" rel="noreferrer">Photos</a>
                </li>
                {/* <li>
                  <a href="#download" target="_blank" rel="noreferrer">Audio et autres ressources</a>
                </li> */}
              </ul>
            </div>
